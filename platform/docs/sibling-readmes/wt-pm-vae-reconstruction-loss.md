...
**wt-pm** platform wraps the original `model.py` through adapter `m22-vae-reconstruction` —
...
| Integration role | Reconstruction anomaly stream. Hermes `anomaly`. |
...
wt-pm inspect          # see m22-vae-reconstruction availability
