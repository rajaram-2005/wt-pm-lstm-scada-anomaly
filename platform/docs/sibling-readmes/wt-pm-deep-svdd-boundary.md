...
**wt-pm** platform wraps the original `model.py` through adapter `m13-deep-svdd` —
...
| Integration role | One-class anomaly stream. Hermes `anomaly`. Fallback m14. |
...
wt-pm inspect          # see m13-deep-svdd availability
